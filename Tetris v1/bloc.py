...
class Bloc:
    ...
    def __init__(self):
        ...
        self.x       =   random.randint(0, SIZE_MATRIX_X - self.size_x - 1)
        self.y       =   4 - self.size_x
    ...
    def collision(self, blocs):
        ...
        for position in positions_bloc_1:
            if position[0] >= SIZE_MATRIX_X or position[1] >= SIZE_MATRIX_Y:
                return True
    ...
    def can_turn_left(self, blocs):
        ...
        self.turn_left()
        condition = not self.__out_of_dimension() and not self.collision(blocs)
        self.turn_right()
